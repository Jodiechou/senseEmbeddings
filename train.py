...
def train(train_path, eval_path, glove_path, out_path, merge_strategy='mean', max_seq_len=512, max_instances=float('inf')):
...
if __name__ == '__main__':
	...
	train(train_path, keys_path, args.glove_path, args.out_path, args.merge_strategy, args.max_seq_len, args.max_instances)