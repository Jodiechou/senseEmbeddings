...
if __name__ == '__main__':
	...
	if args.bert == 'large':
		...
		save_sense_matrix_path = 'data/vectors/senseMatrix.semcor_diagonal_linear_large_{}_20.npz'.format(args.emb_dim)
		save_weight_path = 'data/vectors/weight.semcor_diagonal_linear_1024_{}_20.npz'.format(args.emb_dim)
	elif args.bert == 'base':
