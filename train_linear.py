...
def load_glove_embeddings():
	...
	embed_g = []
	senses = []
	with open('data/vectors/glove_embeddings.small.txt', 'r') as gfile:
		for line in gfile:
	...
	print('first sense: ', senses[0])
	print('first embeddings', embed_g[0])
...
def load_bert_embeddings():
	...
	embed_c = []
	with open('data/vectors/bert_embeddings.small.txt', 'r') as cfile:
		for line in cfile:
			splitLine = line.split(' ')
...
if __name__ == '__main__':
	...
	matirx_path = 'data/vectors/senseMatrix.300.300.test.txt'
	...
	senseEmbed_path = 'data/vectors/senseEmbed.300.test.txt'
	...
	w1_path = 'data/vectors/weight.1024.300.npy'
