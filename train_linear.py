...
if __name__ == '__main__':
	...
	matirx_path = 'data/output/senseMatrix.small.300.300.txt'
	...
	senseEmbed_path = 'data/output/senseEmbed.small.300.txt'
	...
	w_path = 'data/output/weight.small.1024.300.txt'
	with open(w_path, 'w') as wf:
		w_str = ' '.join([str(v) for v in weight])
		wf.write('%s' % (w_str))
