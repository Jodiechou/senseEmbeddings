...
def load_glove_embeddings():
	...
	embed_g = []
	senses = []
	with open('data/vectors/glove_embeddings.small.300.txt', 'r') as gfile:
		for line in gfile:
...
def load_bert_embeddings():
	...
	embed_c = []
	with open('data/vectors/bert_embeddings.small.1024.txt', 'r') as cfile:
		for line in cfile:
			splitLine = line.split(' ')
...
if __name__ == '__main__':
	...
	matirx_path = 'data/vectors/senseMatrix.small.300.300.txt'
	...
	senseEmbed_path = 'data/vectors/senseEmbed.small.300.txt'
	...
	w1_path = 'data/vectors/weight.small.1024.300.npy'
