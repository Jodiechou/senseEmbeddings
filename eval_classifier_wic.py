...
def get_args(
	...
	# parser.add_argument('-load_weight_path', default='data/vectors/weight.semcor_gloss_diagonal_linear_2048_{}_50.npz'.format(emb_dim))
...
if __name__ == '__main__':
	...
	with open(results_path, 'w') as results_f:  # store results in WiC's format
		for wic_idx, wic_entry in enumerate(load_wic(args.eval_set, wic_path='external/wic')):
			...
			# ex2_lmms_vec = torch.from_numpy(lmms[ex2_matches[0][0]])
