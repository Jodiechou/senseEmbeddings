...
from eval import SensesVSM
from eval import load_wsd_fw_set
from eval import get_id2sks
...
def get_args(
	...
	parser.add_argument('-load_sv_path', help='Path to sense vectors', default='data/vectors/senseMatrix.semcor_gloss_diagonal_relu_large_bertlast4layers_multiword_{}_20.npz'.format(emb_dim))
	parser.add_argument('--load_weight_path', default='data/vectors/weight.semcor_gloss_diagonal_relu_bertlast4layers_multiword_2048_{}_20.npz'.format(emb_dim))
...
if __name__ == '__main__':
	...
	if args.bert == 'large':
		...
		save_sense_matrix_path = 'data/vectors/senseMatrix.semcor_gloss_diagonal_relu_large_bertlast4layers_multiword_{}_50.npz'.format(args.emb_dim)
		save_weight_path = 'data/vectors/weight.semcor_gloss_diagonal_relu_bertlast4layers_multiword_2048_{}_50.npz'.format(args.emb_dim)
	...
	for epoch in range(args.num_epochs):
		...
		cum_loss /= count
		logging.info("epoch: %d, train_loss: %f" %(epoch, cum_loss))
