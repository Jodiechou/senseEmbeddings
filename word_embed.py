...
def train(train_path, eval_path, glove_path, merge_strategy='mean', max_seq_len=512, max_instances=float('inf')):
	...
	# # Embedding files only contain vectors
	...
	#Embedding files contain word and vectors
	outg_path = 'data/vectors/glove_embeddings.full.txt'
	outc_path = 'data/vectors/bert_embeddings.full.txt'
	with open(outg_path, 'w') as fvecs_out1:
