...
def get_args(
	...
	parser.add_argument('--save_sense_matrix_path', default='data/vectors/senseMatrix.semcor_diagonal_valid_norm_{}.npz'.format(emb_dim))
	parser.add_argument('--save_weight_path', default='data/vectors/weight.semcor_diagonal_valid_norm_1024_{}.npz'.format(emb_dim))
